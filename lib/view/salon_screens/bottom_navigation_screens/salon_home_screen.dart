...
class _SalonHomeScreenState extends State<SalonHomeScreen> with SingleTickerProviderStateMixin{
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text('شارع الثروة , عمان ,الاردن',style: TextStyle(
                          color: Colors.white
                        ),textDirection: TextDirection.rtl,)
                      ],
                    )
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: 30,),
              CustomButton(label: 'احجز باستخدام QR code',),
              SizedBox(height: 20,),
              Container(
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      textDirection: TextDirection.rtl,
                                      children: [
                                        Text('صبغة + ماسكات',style: TextStyle(
                                          color: Colors.grey,
                                          fontSize: 18
                                        ),textDirection: TextDirection.rtl,),
                                      ],
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(width: 10,),
                                        Text('تامر احمد',style: TextStyle(
                                          color: Colors.grey
                                        ),textDirection: TextDirection.rtl,)
                                      ],
                                    ),
