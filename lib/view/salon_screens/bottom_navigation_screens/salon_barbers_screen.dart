      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              SizedBox(height: 30,),
              CustomButton(label: 'اضافة حلاق جديد',
              onTab: (){
                showCustomBottomSheet(
                  context: context,
                  content:Column(
                    children: [
                      Text('scan Salon QR code from barber account',style: TextStyle(
                          fontSize: 15,
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                Text('ادهم خالد',style: TextStyle(
                                  color: kDarkBlueColor,
                                  fontSize: 18
                                ),textDirection: TextDirection.rtl,),
                                Text('فرع : عمان',style: TextStyle(
                                  color: kPrimaryColor,
                                  fontSize: 16
                                ),textDirection: TextDirection.rtl,)
                              ],
                            ...
                            Container(
                              ...
                              child: Center(
                                child: Text('متاح',style: TextStyle(
                                  color: Colors.white
                                ),),
                              ),
                            )
