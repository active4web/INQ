...
class _BarberServicesScreenState extends State<BarberServicesScreen> with SingleTickerProviderStateMixin{
                              ...
                              InkWell(
                                onTap: (){
                                  showCustomBottomSheet(
                                    ...
                                    content:Column(
                                      children: [
                                        Text('تعديل الوقت',style: TextStyle(
